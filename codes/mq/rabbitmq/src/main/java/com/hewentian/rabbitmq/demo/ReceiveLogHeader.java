...
/**
 * <p>
 * <b>ReceiveLogHeader.java</b> 是
 * </p>
 *
 * @author <a href="mailto:wentian.he@qq.com">hewentian</a>
 * @date 2018-01-21 10:11:40 PM
 * @since JDK 1.8
 */
public class ReceiveLogHeader {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        argv = new String[]{"myqueue", "x-match", "any", "method", "get"};
        ...
        // receive information from the sender here as the routing key is still
        // available in the received message.
        String routingKeyFromUser = "ourTestRoutingKey";

        // Argument processing: the first arg is the local queue name, the rest are key
        // value pairs for headers.
        ...
        // RabbitMQ Note that when you run this code you should include the x-match
        // header on the command line. Example:
